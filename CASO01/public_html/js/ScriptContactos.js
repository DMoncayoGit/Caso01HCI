                ...
                "render": function(data, type, row) {
                    ...
                    return `
                        <button class="btn btn-info btn-sm btnVer" 
                                ...
                                data-fotografia="${row.fotografia}">Ver</button>
                        ...
                        <button class="btn btn-warning btn-sm btnEditar" 
                                ...
                                data-correo="${row.correo}" 
                                data-telefono="${row.telefono}" 
                                data-fotografia="${row.fotografia}">Editar</button>

                        <button class="btn btn-danger btn-sm btnEliminar" data-identificacion="${row.identificacion}">Eliminar</button>
                    `;
                }
            }
        ],
