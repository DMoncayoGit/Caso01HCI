    ...
    function cargarUbicaciones() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#codigo_ubicacion').append('<option value="">Seleccione una dirección</option>'); 
                ...
                $('#codigo_ubicacionEditar').append('<option value="">Seleccione una dirección</option>'); 
    ...
    function cargarContactos() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#identificacion').append('<option value="">Seleccione un Contacto</option>');  
                ...
                $('#identificacionEditar').append('<option value="">Seleccione un Contacto</option>');  
                ...
                "render": function(data, type, row) {
                    ...
                    return `
                        ...
                        <button class="btn btn-info btn-sm btnVer" 
                                ...
                                data-ubicacion="${row.codigo_ubicacion}"> Ver </button>
                        ...
                        <button class="btn btn-warning btn-sm btnEditar" 
                                ...
                                data-recordatorio="${row.recordatorio}" 
                                data-identificacion="${row.identificacion}" 
                                data-codigo_ubicacion="${row.codigo_ubicacion}">Editar</button>

                        <button class="btn btn-danger btn-sm btnEliminar" data-codigo_evento="${row.codigo_evento}">Eliminar</button>
                    `;
                }
            }
        ],
