        ...
        "columns": [
            ...
            { "data": "longitud"},
            {
                ...
                "render": function(data, type, row) {
                    ...
                    return `
                        <button class="btn btn-warning btn-sm btnEditar" data-codigo_ubicacion="${row.codigo_ubicacion}" data-direccion="${row.direccion}" data-latitud="${row.latitud}" data-longitud="${row.longitud}">Editar</button>
                        <button class="btn btn-danger btn-sm btnEliminar" data-codigo_ubicacion="${row.codigo_ubicacion}">Eliminar</button>
                    `;
                }
            }
        ],
